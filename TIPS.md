...
Xcode15快捷键：
  ...
  - <kbd>⌘ + J</kbd> 移动焦点到编辑器
  - <kbd>⌘ + ⇧ + J</kbd> 移动焦点到导航区域
  - <kbd>⌘ + ⌥ + ⇧ + J</kbd> 移动焦点到实用工具区域
  - <kbd>⌘ + ⌥ + J</kbd> 移动焦点到调试区域
  - <kbd>⌘ + ⌥ + C</kbd> 复制当前文件的路径
  - <kbd>⌘ + ⌥ + ⇧ + C</kbd> 复制当前文件的引用
  - <kbd>⌘ + ⌥ + S</kbd> 保存当前文件的状态
  - <kbd>⌘ + ⌥ + ⇧ + S</kbd> 恢复当前文件的状态
  - <kbd>⌘ + ⌥ + T</kbd> 显示或隐藏编辑器的辅助编辑器
  - <kbd>⌘ + ⌥ + ⇧ + T</kbd> 显示或隐藏编辑器的版本编辑器
  - <kbd>⌘ + ⌥ + P</kbd> 暂停或恢复自动刷新
  - <kbd>⌘ + ⌥ + ⇧ + P</kbd> 刷新当前文件
  - <kbd>⌘ + ⌥ + =</kbd> 放大字体
  - <kbd>⌘ + ⌥ + -</kbd> 缩小字体
  - <kbd>⌘ + ⌥ + 0</kbd> 恢复默认字体
  - <kbd>⌘ + ⌥ + M</kbd> 将选中的代码抽取为方法
  - <kbd>⌘ + ⌥ + E</kbd> 将选中的代码封装为表达式
  - <kbd>⌘ + ⌥ + V</kbd> 将选中的代码提取为变量
  - <kbd>⌘ + ⌥ + C</kbd> 将选中的代码提取为常量
  - <kbd>⌘ + ⌥ + P</kbd> 将选中的代码提取为属性
  - <kbd>⌘ + ⌥ + I</kbd> 将选中的代码缩进
  - <kbd>⌘ + ⌥ + ⇧ + F</kbd> 格式化选中的代码
  - <kbd>⌘ + ⌥ + ⇧ + B</kbd> 跳转到当前文件的构建设置
  - <kbd>⌘ + ⌥ + ⇧ + C</kbd> 跳转到当前文件的代码覆盖率
  - <kbd>⌘ + ⌥ + ⇧ + M</kbd> 跳转到当前文件的内存图
  - <kbd>⌘ + ⌥ + ⇧ + V</kbd> 跳转到当前文件的视图调试器
  - <kbd>⌘ + ⌥ + ⇧ + X</kbd> 跳转到当前文件的性能测试
  - <kbd>⌘ + ⌥ + ⇧ + Z</kbd> 跳转到当前文件的快照
  - <kbd>⌘ + ⌥ + ⇧ + T</kbd> 跳

源: 与必应的对话， 2023/11/3
(1) 快快拿走，Xcode 常用快捷键 - 知乎 - 知乎专栏. https://zhuanlan.zhihu.com/p/58628848.
(2) Xcode快捷键大全 - 掘金. https://juejin.cn/post/6844903930346864648.
(3) [翻译]你不可错过的 10 个 Xcode 技巧和快捷键 - 掘金. https://juejin.cn/post/6913888065937211399.
