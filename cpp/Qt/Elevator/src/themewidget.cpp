...
DataTable ThemeWidget::generateRandomData(targetMode mode_name) {
  ...
  switch (mode_name) {
    case velocity:
      read_testdata_data(time_data_velocity, target_data_velocity,
                         PROJECT_PATH + string("/data/velocity/testdata.txt"),
                         dataType::ideal);
      ...
      read_testdata_data(time_data_velocity, test_data_velocity,
                         PROJECT_PATH + string("/data/velocity/testdata.txt"),
                         dataType::test);
      dataTable << txt_data_into_dataList(
      ...
      using_net(test_data_velocity, target_data_velocity, label_data_velocity,
                "/data/velocity/traindata.txt", "/data/velocity/testdata.txt");
      ...
      break;
    case decibel:
      read_testdata_data(time_data_decibel, target_data_decibel,
                         PROJECT_PATH + string("/data/decibel/testdata.txt"),
                         dataType::ideal);
      dataTable << txt_data_into_dataList(
      ...
      read_testdata_data(time_data_decibel, test_data_decibel,
                         PROJECT_PATH + string("/data/decibel/testdata.txt"),
                         dataType::test);
      ...
      using_net(test_data_decibel, target_data_decibel, label_data_decibel,
                "/data/decibel/traindata.txt", "/data/decibel/testdata.txt");
      ...
      dataTable << txt_data_into_dataList(time_data_decibel, label_data_decibel,
                                          ...
                                          m_y_max_decibel, m_x_time_decibel);
    case vibration:
      read_testdata_data(time_data_vibration, target_data_vibration,
                         PROJECT_PATH + string("/data/vibration/testdata.txt"),
                         dataType::ideal);
      dataTable << txt_data_into_dataList(
      ...
      read_testdata_data(time_data_vibration, test_data_vibration,
                         PROJECT_PATH + string("/data/vibration/testdata.txt"),
                         dataType::test);
      dataTable << txt_data_into_dataList(
      ...
      using_net(test_data_vibration, target_data_vibration,
                label_data_vibration, "/data/vibration/traindata.txt",
                "/data/vibration/testdata.txt");
