...
MyPublisherRealTimerTestone::MyPublisherRealTimerTestone(QObject *parent)
	:m_pause(false)
	,currentframe(false)
	,m_first_flag(true)
	,index (0)
...
MyPublisherRealTimerTestone::~MyPublisherRealTimerTestone()
{
}

void MyPublisherRealTimerTestone::slotsimPublisher()
{
...
void MyPublisherRealTimerTestone::updateEvent()
{
	if (m_first_flag)
	{
...
void MyPublisherRealTimerTestone::slotsimPause()
{
	m_pause = true;
	SimMessageDDs simdds;
...
void MyPublisherRealTimerTestone::slotsimGoOn()
{
	m_pause = false;
	SimMessageDDs simdds;
...
void MyPublisherRealTimerTestone::slotsimQuit()
{
...
bool MyPublisherRealTimerTestone::ishistory()
{
...
bool MyPublisherRealTimerTestone::ishistorytest()
{	
	if (currentframe == false) { return false; }
	while (true)
	{
