...
#ifndef SimCentrePubSubTypes_h__
#define SimCentrePubSubTypes_h__
...
#error Generated SimMessage is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type SimMessage defined by the user in the IDL file.
 * @ingroup HELLOWORLD
 */
class SimCentrePubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef SimMessage type;

    eProsima_user_DllExport SimCentrePubSubType();

    eProsima_user_DllExport virtual ~SimCentrePubSubType();
...
#endif // SimCentrePubSubTypes_h__