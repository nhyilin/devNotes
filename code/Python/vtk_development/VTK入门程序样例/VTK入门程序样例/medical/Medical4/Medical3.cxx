...
void main( int argc, char *argv[] )
{
	...
	*/
	...
	vtkVolume16Reader *v16 = vtkVolume16Reader::New();
	v16->SetDataDimensions(460,460);
	v16->SetDataByteOrderToLittleEndian();
	v16->SetFilePrefix ("E://CT/us_picture/refarray");
	v16->SetImageRange(1, 41);
	v16->SetDataSpacing (3.2, 3.2, 7);
	...
	saggitalSection->SetInputConnection(v16->GetOutputPort());
	...
	axialSection->SetInputConnection(v16->GetOutputPort());
	...
	coronalSection->SetInputConnection(v16->GetOutputPort());
