...
int main()
{
  ...
  sphere->SetThetaResolution(100);//纬度方向的点数
  sphere->SetPhiResolution(50);

  vtkSphereSource *sp = vtkSphereSource::New();
  sp->SetThetaResolution(100);//纬度方向的点数
  sp->SetPhiResolution(50);
  sp->SetRadius  (1) ; 

  vtkPolyDataMapper *sphereMapper1 = vtkPolyDataMapper::New();
  sphereMapper1->SetInputConnection(sp->GetOutputPort());
  ...
  sphere2->SetMapper(sphereMapper1);
